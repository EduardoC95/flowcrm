...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Novo evento', href: '/calendar-events/create' },
];
...
const submit = () => form.post('/calendar-events');
</script>
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <form class="flex h-full flex-1 flex-col gap-5 p-4" @submit.prevent="submit">
            <section>
                <h1 class="text-2xl font-semibold tracking-tight">Novo evento</h1>
                <p class="text-sm text-muted-foreground">Agenda uma tarefa, chamada, reunião, nota ou lembrete comercial.</p>
            </section>
